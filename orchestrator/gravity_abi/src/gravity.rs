...
mod gravity {
    ...
    impl<M: ethers::providers::Middleware> Gravity<M> {
        ...
        #[doc = "Calls the contract's `sendToSankofa` (0x53c5060c) function"]
        pub fn send_to_sankofa(
            &self,
            token_contract: ethers::core::types::Address,
    ...
    #[doc = "Container type for all input parameters for the `sendToSankofa` function with signature `sendToSankofa(address,address,uint256)` and selector `[83, 197, 6, 12]`"]
    #[derive(
        Clone,
        Debug,
        Eq,
    ...
    #[ethcall(name = "sendToSankofa", abi = "sendToSankofa(address,address,uint256)")]
    pub struct SendToSankofaCall {
        pub token_contract: ethers::core::types::Address,
    ...
    pub enum GravityCalls {
        ...
        SendToSankofa(SendToSankofaCall),
    ...
    impl ethers::core::abi::AbiDecode for GravityCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <SendToSankofaCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GravityCalls::SendToSankofa(decoded));
            }
            if let Ok(decoded) =
    ...
    impl ethers::core::abi::AbiEncode for GravityCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                GravityCalls::SendToSankofa(element) => element.encode(),
    ...
    impl ::std::fmt::Display for GravityCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                GravityCalls::SendToSankofa(element) => element.fmt(f),
    ...
    impl ::std::convert::From<SendToSankofaCall> for GravityCalls {
        fn from(var: SendToSankofaCall) -> Self {
            GravityCalls::SendToSankofa(var)
        }
    }
